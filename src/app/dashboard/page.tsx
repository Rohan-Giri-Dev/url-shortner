      ...
      <section className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        <header className="rounded-lg border border-white/10 bg-neutral-950 px-5 py-5 shadow-2xl shadow-black/20 sm:px-6">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            ...
            {latestUrl && (
              <div className="w-full rounded-lg border border-emerald-400/20 bg-emerald-400/10 p-4 lg:max-w-md">
              ...
              <div className="divide-y divide-white/10">
                {urls.map((url) => {
                  ...
                  return (
                    <article
                      key={url.id}
                      className="grid gap-4 px-5 py-5 transition hover:bg-white/[0.03] xl:grid-cols-[minmax(0,1fr)_160px_100px]"
                    >
